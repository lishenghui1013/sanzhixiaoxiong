...
$('#shopCfg').validator({
          ...
          valid: function(form){
            ...
            $.post(WST.U('home/Shoprenzheng/editshop'),params,function(data,textStatus){
                console.log(data);
              layer.close(loading);
...
function delBatchUploadImg(obj){
    var c = WST.confirm({content:'您确定要删除实景图吗?',yes:function(){
