<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:83:"/www/wwwroot/sanzhixiaoxiong/wstmart/home/view/default/shops/goods/shop_shezhi.html";i:1545642728;s:70:"/www/wwwroot/sanzhixiaoxiong/wstmart/home/view/default/shops/base.html";i:1542789671;s:70:"/www/wwwroot/sanzhixiaoxiong/wstmart/home/view/default/header_top.html";i:1540775116;s:70:"/www/wwwroot/sanzhixiaoxiong/wstmart/home/view/default/shop_apply.html";i:1523179176;s:66:"/www/wwwroot/sanzhixiaoxiong/wstmart/home/view/default/footer.html";i:1540022560;}*/ ?>
<!doctype html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
<title>店铺设置-卖家中心<?php echo WSTConf('CONF.mallTitle'); ?></title>
...
<div class="wst-clear"></div>
   <div class="wst-shop-content">
    ...
    <form name="shopCfg"  id="shopCfg" autocomplete="off" method="post">
		...
		<input type="hidden" id="type" class="ipt" value="<?php echo $type; ?>" />
           <tr>
             <th width='120' align='right'>店铺名称<font color='red'>*</font>：</th>
             <td><input type='text' id='shopName' name='shopName' class="ipt"  value='<?php echo isset($object['shopName'])?$object['shopName']:''; ?>' data-rule='店铺名称:required;' style='width:350px;' maxLength='25' /><a target="_blank" href="<?php echo url('seller/company'); ?>">店铺主页</a></td>
		    ...
		    <tr style="height:80px">
             ...
             <td>
              ...
              <div class="wst-lfloat shopbanner" <?php if(empty($object['shopImg'])): ?>style='display:none'<?php endif; ?>>
                <img id="shopBannerPreview" class="lazyImg" height="100" style="max-width:500px;" src="__ROOT__/<?php echo isset($object['shopImg'])?$object['shopImg']:''; ?>">
                <span class="del-banner" onclick="delbanner(this)">删除</span>
              </div>
                <input type="hidden" id="shopImg" class="ipt" value="<?php echo isset($object['shopImg'])?$object['shopImg']:''; ?>" />
              </div>
             </td>
           </tr>
           <tr>
           ...
           <td colspan='3'>
               <textarea rows="2" style='width:400px;height:200px' class="ipt" id='shopDesc' name='shopDesc' ><?php echo isset($object['shopDesc'])?$object['shopDesc']:''; ?></textarea>
           </td>
           </tr>
           <tr>
           <th width='120'>产品介绍</th>
           <td><textarea rows="2" style='width:400px;height:200px' class="ipt" id='goodsDesc' name='goodsDesc' ><?php echo isset($object['goodsDesc'])?$object['goodsDesc']:''; ?></textarea></td>
         </tr>
           <tr>
           <th width='120'>联系方式</th>
           <td><textarea rows="2" style='width:400px;height:200px' class="ipt" id='contact' name='contact' ><?php echo isset($object['contact'])?$object['contact']:''; ?></textarea></td>
         </tr>
            ...
            <td colspan='2'>
                <div class="box">
                    <div id="upload-58e7a59ad3bce" class="xb-uploader">
                        <div class="queueList">
                            <div class="placeholder <?php if(!empty($object['shopView'])): ?>element-invisible<?php endif; ?>">
                                <div class="filePicker"></div>
                                <p>或将照片拖到这里，单次最多可选50张,每张最大不超过5M </p>
                            </div>
                            <ul class="filelist" >
                                <?php if(!(empty($object['shopView']) || ($object['shopView'] instanceof \think\Collection && $object['shopView']->isEmpty()))): if(is_array($object['shopView']) || $object['shopView'] instanceof \think\Collection): $i = 0; $__LIST__ = $object['shopView'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                        ...
                        <div class="statusBar" <?php if(empty($object['shopView'])): ?>style="display: none;"<?php endif; ?>">
             ...
             <td>
                  ...
                  <div id="batchUpload" class="wst-batchupload" style="border:1px solid #ccc">
                    ...
                    <div class="queueList filled">
                        ...
                        <ul class="filelist" >
						<?php if(!(empty($object['shopAds']) || ($object['shopAds'] instanceof \think\Collection && $object['shopAds']->isEmpty()))): if(is_array($object['shopAds']) || $object['shopAds'] instanceof \think\Collection): $i = 0; $__LIST__ = $object['shopAds'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
...
<script type='text/javascript' src='__STYLE__/shops/shopconfigs/shop_cfg.js?v=<?php echo $v; ?>'></script>
