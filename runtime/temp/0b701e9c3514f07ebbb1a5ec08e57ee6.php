<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:85:"/www/wwwroot/sanzhixiaoxiong/wstmart/home/view/default/shops/goodsappraises/list.html";i:1523179174;s:70:"/www/wwwroot/sanzhixiaoxiong/wstmart/home/view/default/shops/base.html";i:1542789671;s:70:"/www/wwwroot/sanzhixiaoxiong/wstmart/home/view/default/header_top.html";i:1540775116;s:70:"/www/wwwroot/sanzhixiaoxiong/wstmart/home/view/default/shop_apply.html";i:1523179176;s:66:"/www/wwwroot/sanzhixiaoxiong/wstmart/home/view/default/footer.html";i:1540022560;}*/ ?>
<!doctype html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
<title>评价列表-卖家中心<?php echo WSTConf('CONF.mallTitle'); ?></title>
...
<div class="wst-shop-tbar">
  ...
  <label>
    商品名称：<input type="text" name="goodsName" id="goodsName" class="s-query" /><button class="s-btn" onclick="queryByPage()">查询</button>
  </label>
</div>
   ...
   <tr>
      ...
      <td rowspan="2">
          ...
          <a href="{{WST.U("home/goods/detail","id="+d[i]['goodsId'])}}">
            <img class='gImg'  data-original='__ROOT__/{{d[i].goodsImg}}'/>
          </a>
        </div>
   ...
   <tr style="border-bottom:1px solid #ccc;">
         <td colspan='3'>评价[{{d[i]['loginName']}}]：{{d[i]['content']}}
            ...
            <div class="reply-box">
              ...
              <button class="reply-btn s-btn" onclick="reply(this,{{d[i]['gaId']}})">回复</button>
              {{# }else{ }}
...
<script type='text/javascript' src='__STYLE__/shops/goodsappraises/goodsappraises.js?v=<?php echo $v; ?>'></script>
<script>
$(function(){
  queryByPage();
})
