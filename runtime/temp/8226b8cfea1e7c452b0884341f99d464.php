<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:91:"/www/wwwroot/sanzhixiaoxiong/wstmart/home/view/default/shops/orders/list_wait_delivery.html";i:1545011803;s:70:"/www/wwwroot/sanzhixiaoxiong/wstmart/home/view/default/shops/base.html";i:1542789671;s:70:"/www/wwwroot/sanzhixiaoxiong/wstmart/home/view/default/header_top.html";i:1540775116;s:70:"/www/wwwroot/sanzhixiaoxiong/wstmart/home/view/default/shop_apply.html";i:1523179176;s:66:"/www/wwwroot/sanzhixiaoxiong/wstmart/home/view/default/footer.html";i:1540022560;}*/ ?>
<!doctype html>
<head>
...
<div class="wst-wrap">
  ...
  <div class='wst-shop-tbar'>
     ...
     <button class="s-btn" onclick="waitDivleryByPage()">查询</button>
     <button class="s-btn" style="float: right;" onclick="javascript:toExport(2,0,'')">导出</button>
  </div>
    ...
    <table class='wst-order-list'>
       ...
       <tbody class="j-order-row">
         ...
         <tr class='goods-box'>
            ...
            <td rowspan="{{rows}}">
                {{#if((d[i].payType==1 && d[i].isPay==1) || d[i].payType==0){}}
                <div><a href='#none' onclick='javascript:deliver({{d[i].orderId}})'>【发货】</a></div>
                {{#}}}
