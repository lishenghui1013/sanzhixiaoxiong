<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:84:"E:\demo\sanzhixiaoxiong/wstmart/home\view\default\shops\spell\list_spell_detail.html";i:1539337698;s:65:"E:\demo\sanzhixiaoxiong/wstmart/home\view\default\shops\base.html";i:1529571610;s:65:"E:\demo\sanzhixiaoxiong/wstmart/home\view\default\header_top.html";i:1523179176;s:65:"E:\demo\sanzhixiaoxiong/wstmart/home\view\default\shop_apply.html";i:1523179176;s:61:"E:\demo\sanzhixiaoxiong/wstmart/home\view\default\footer.html";i:1523179174;}*/ ?>
<!doctype html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
<title>参团人员列表-卖家中心<?php echo WSTConf('CONF.mallTitle'); ?></title>
...
<div class="wst-shop-content"> 
   ...
   <tr>
       ...
       <td>
           <?php switch($vo['orderStatus']): case "-3": ?>用户拒收<?php break; case "-2": ?>未付款<?php break; case "0": ?>待发货<?php break; case "1": ?>配送中<?php break; case "2": ?>用户确认收货<?php break; default: ?>NULL
           <?php endswitch; ?>
       </td>
       <td>
           <?php switch($vo['deliverType']): case "1": ?>自提<?php break; case "0": ?>送货上门<?php break; default: ?>NULL
           <?php endswitch; ?>
       </td>
       <td><?php echo $vo['totalMoney']; ?></td>
       <td>
           <?php switch($type): case "0": ?><a class="g-handle" href='#'>[拼团中]</a><?php break; case "1": ?><a class="g-handle" href='#'>[已成团]</a><?php break; case "2": switch($vo['isRefund']): case "1": ?><a class="g-handle" href="javascript:;">[已退款]</a><?php break; case "0": ?><a class="g-handle"  href="javascript:btn(<?php echo $vo['orderId']; ?>,<?php echo $vo['team_id']; ?>)">[退款]</a><?php break; default: ?>NULL
                   <?php endswitch; break; default: ?>NULL
           <?php endswitch; ?>
       </td>
   </tr>
<?php endforeach; endif; else: echo "" ;endif; ?>
...
<script>
    function btn(refund,team_id){
        $.ajax({
            url:"<?php echo url('home/spell/refund'); ?>",
            type:"POST",
