<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:63:"E:\demo\sanzhixiaoxiong/wstmart/admin\view\agent\uploadads.html";i:1541146930;s:52:"E:\demo\sanzhixiaoxiong/wstmart/admin\view\base.html";i:1523179156;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
<head>
<meta charset="utf-8">
  ...
  <!-- <tr>
      <th width='150'>位置类型<font color='red'>*</font>：</th>
       ...
       <tr>
	    ...
	    <input type="hidden" id="positionType" name="positionType" class="ipt" value="<?php if($shopId == '-1'): ?>1<?php else: ?>2<?php endif; ?>
    "/>
	    <input type="hidden" id="adPositionId" name="adPositionId" class="ipt" value="<?php echo $positionid; ?>"/>
	    <input type="hidden" id="shopId" name="shopId" class="ipt" value="<?php echo $shopId; ?>"/>
	   <input type="hidden" id="adName" name="adName" class="ipt" value="共享"/>
       <tr>
