...
<div class="wst-shop-head"><span>广告列表</span></div>
<div class="wst-shop-tbar">
  ...
  <!--</label>-->
  <!--<label>-->
    <!--到期时间：<input type="text" name="goodsName" id="expiryTime" placeholder="点击选择时间" class="s-query" /><button class="s-btn" onclick="saleByPage()">托管</button>-->
  <!--</label> -->
    <label>
        托管期限：<select id="monthNum" class="j-bareas1 s-query" >
        ...
        <button class="s-btn" onclick="saleByPage()">托管</button>注：托管从次月开始
  </label>
</div>
<div class="wst-shop-content">
   <div class="s-menu">
      <!--<a href='javascript:void(0);' onclick="benchDel('spellSale')" class="s-del"><span>删除</span></a>-->
      <a href='<?php echo url("home/Shopbanner/addBanner"); ?>' class="s-add"><span>新增</span></a>
      <!--<a href='<?php echo url("home/Shopbanner/addBanner"); ?>' class="s-rec" title="点击托管广告"><span>托管</span></a>-->
   </div>
   ...
   <tr>
        ...
        <td><img class="j-lazyGoodsImg" data-original="__ROOT__/<?php echo $vo['adFile']; ?>"  src="__ROOT__/<?php echo $vo['adFile']; ?>"></td>
      ...
      <td>
          <?php if(empty($tuoguan) || ($tuoguan instanceof \think\Collection && $tuoguan->isEmpty())): ?>
              <a class="g-handle" href='javascript:dele(<?php echo $vo['adId']; ?>)'>[删除]</a>
              <a class="g-handle" href='<?php echo url("home/Shopbanner/Edit"); ?>?id=<?php echo $vo['adId']; ?>'>[编辑]</a>
          <?php else: ?>
              <a class="g-handle" href='javascript:;'>[已托管]</a>
          <?php endif; ?>
      </td>
   </tr>
<?php endforeach; endif; else: echo "" ;endif; ?>
