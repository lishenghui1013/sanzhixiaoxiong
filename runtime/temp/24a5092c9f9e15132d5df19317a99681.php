<?php if (!defined('THINK_PATH')) exit(); /*a:8:{s:64:"E:\demo\sanzhixiaoxiong/wstmart/home\view\default\self_shop.html";i:1523179174;s:59:"E:\demo\sanzhixiaoxiong/wstmart/home\view\default\base.html";i:1523179174;s:71:"E:\demo\sanzhixiaoxiong/wstmart/home\view\default\self_shop_header.html";i:1523179174;s:65:"E:\demo\sanzhixiaoxiong/wstmart/home\view\default\header_top.html";i:1523179176;s:65:"E:\demo\sanzhixiaoxiong/wstmart/home\view\default\shop_apply.html";i:1523179176;s:61:"E:\demo\sanzhixiaoxiong/wstmart/home\view\default\header.html";i:1523179170;s:65:"E:\demo\sanzhixiaoxiong/wstmart/home\view\default\right_cart.html";i:1523179174;s:61:"E:\demo\sanzhixiaoxiong/wstmart/home\view\default\footer.html";i:1523179174;}*/ ?>
<!doctype html>
<head>
	...
	<div class="s-cat">
		 <?php if(is_array($data['shopcats']) || $data['shopcats'] instanceof \think\Collection): $i = 0;$__LIST__ = is_array($data['shopcats']) ? array_slice($data['shopcats'],0,6, true) : $data['shopcats']->slice(0,6, true); if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cat1): $mod = ($i % 2 );++$i;?>
		  <div class="shop-cat1" cid="<?php echo $key; ?>" id="ct1-<?php echo $key; ?>">
		  	...
		  	<h3>
	  		 <a href="<?php echo url('home/shops/home',['shopId'=>$data['shop']['shopId'],'ct1'=>$cat1['catId']]); ?>"><?php echo WSTMSubstr($cat1['catName'],0,4); ?></a>
	  		</h3>
	  		</div>
	  		...
	  		<p class="shop-ct1-ct2">
	  			...
	  			<a href="<?php echo url('home/shops/home',['shopId'=>$data['shop']['shopId'],'ct1'=>$cat1['catId'],'ct2'=>$v1['catId']]); ?>"><?php echo $v1['catName']; ?></a> 
	  			<?php endforeach; endif; else: echo "" ;endif; ?>
	  		</p>
		 </div>
	      ...
	      <ul class="shop-cat2 cid<?php echo $key; ?>" cid="<?php echo $key; ?>">
	      	<?php if(is_array($cat1['children']) || $cat1['children'] instanceof \think\Collection): $i = 0;$__LIST__ = is_array($cat1['children']) ? array_slice($cat1['children'],0,20, true) : $cat1['children']->slice(0,20, true); if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cat2): $mod = ($i % 2 );++$i;?>
	      		<li><a href="<?php echo url('home/shops/home',['shopId'=>$data['shop']['shopId'],'ct1'=>$cat1['catId'],'ct2'=>$cat2['catId']]); ?>"><?php echo $cat2['catName']; ?></a></li>
	      	<?php endforeach; endif; else: echo "" ;endif; ?>
	      </ul>
	     <?php endforeach; endif; else: echo "" ;endif; ?>
	</div>
...
<div class='wst-container'>
			...
			<ul class="s-rec-goods-list">
				...
				<li>
					...
					<div class="s-rec-goods-bottom">
					   <p class="s-rec-goods-price">价格:<span>￥<?php echo $vo['shopPrice']; ?></span></p>
		...
		<div class="s-rec-goods-list" id="fl_f_1_pl" style="display:none;">
			<ul class="s-rec-goods-list">
				...
				<li>
					...
					<div class="s-rec-goods-bottom">
					   <p class="s-rec-goods-price">价格:<span>￥<?php echo $hot['shopPrice']; ?></span></p>
	...
	<?php if(is_array($data['shopcats']) || $data['shopcats'] instanceof \think\Collection): $l = 0;$__LIST__ = is_array($data['shopcats']) ? array_slice($data['shopcats'],0,5, true) : $data['shopcats']->slice(0,5, true); if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cat1): $mod = ($l % 2 );++$l;?>
	<div class="s-floor-box" >
		...
		<div class="" id="fl_<?php echo $l; ?>_<?php echo $l2; ?>_pl" style="<?php if(($l2 > 1)): ?>display:none;<?php endif; ?>" >
			...
			<div class="s-goods-list">
			 	...
			 	<?php $wstTagShopFloorGoods =  model("Tags")->listShopFloorGoods($cat2['catId'],$data['shop']['shopId'],10,86400); foreach($wstTagShopFloorGoods as $key=>$sgf){?>
	...
	<div class="history-box">
		...
		<div class="history-goods-list">
			<?php $wstTagGoods =  model("Tags")->listGoods("history",0,5,0); foreach($wstTagGoods as $key=>$vo){?>
