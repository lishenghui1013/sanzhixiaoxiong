...
<div class="wst-shop-tbar">
  ...
  <label>
    商品名称：<input type="text" name="goodsName" id="goodsName" class="s-query" /><button class="s-btn" onclick="auditByPage()">查询</button>
  </label>
</div>
<div class="wst-clear"></div>
<div class="wst-body"> 
