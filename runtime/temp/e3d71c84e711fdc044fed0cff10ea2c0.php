<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:79:"/www/wwwroot/sanzhixiaoxiong/wstmart/home/view/default/shops/freights/list.html";i:1523179174;s:70:"/www/wwwroot/sanzhixiaoxiong/wstmart/home/view/default/shops/base.html";i:1542789671;s:70:"/www/wwwroot/sanzhixiaoxiong/wstmart/home/view/default/header_top.html";i:1540775116;s:70:"/www/wwwroot/sanzhixiaoxiong/wstmart/home/view/default/shop_apply.html";i:1523179176;s:66:"/www/wwwroot/sanzhixiaoxiong/wstmart/home/view/default/footer.html";i:1540022560;}*/ ?>
<!doctype html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
<title>运费设置 - 卖家中心<?php echo WSTConf('CONF.mallTitle'); ?></title>
...
<div class="wst-clear"></div>
   ...
   <tr class="wst-fre-hov">
     ...
     <td><input type='text' style='width:80px;' value="<?php echo $shFreight['freight']; ?>" onblur="javascript:freightOnblur(this,'',0)"  onkeyup="javascript:WST.isChinese(this,1)" onkeypress="return WST.isNumberKey(event)"/></td>
   </tr>
   </tbody>
   <tbody id="list-info"></tbody>
</table>
<div class='wst-tbar-group' style='height:76px;text-align:center;'>
     <button class='wst-shop-but' style='margin-top:30px;width:100px;height: 30px;' type="button" onclick='javascript:freightSubmit()'>保&nbsp;存</button>
</div>
</form>
</div>
...
{{#if(typeof(d[i].listProvince[j].freight)=='object'){}}
  	<td><input class='price_{{ d[i].listProvince[j].parentId }} possort ipt' id="{{ d[i].listProvince[j].areaId }}" type='text' style='width:80px;' value="<?php echo $shFreight['freight']; ?>"  onkeyup="javascript:WST.isChinese(this,1)" onkeypress="return WST.isNumberKey(event)"/></td>
{{# }else{ }}
...
<script type='text/javascript' src='__STYLE__/shops/freights/freights.js?v=<?php echo $v; ?>'></script>
<script>
